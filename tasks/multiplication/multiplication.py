...
handling.
"""
from tasks.multiplication.env.config import CONFIG
import tensorflow as tf
import tflearn


class MultiplicationCore():
    def __init__(self, hidden_dim=100, state_dim=128, batch_size=1):
        """
        Instantiate an Multiplication Core object, with the necessary hyperparameters.
        """
