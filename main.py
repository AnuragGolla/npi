...
tf.app.flags.DEFINE_integer("num_training", 200, "Number of training examples to generate.")
tf.app.flags.DEFINE_integer("num_test", 20, "Number of test examples to generate.")
